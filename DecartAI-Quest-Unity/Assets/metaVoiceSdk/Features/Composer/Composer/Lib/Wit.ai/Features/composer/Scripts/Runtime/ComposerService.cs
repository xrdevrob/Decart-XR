...
namespace Meta.WitAi.Composer
{
    public abstract class ComposerService : MonoBehaviour, ILogSource
    {
        ...
        /// <summary>
        /// Send context map event and return a request task
        /// </summary>
        public Task<VoiceServiceRequest> SendContextMapEvent(WitRequestOptions requestOptions)
            => SendEvent(string.Empty, requestOptions);

        /// <summary>
        /// Send event with json and request options
        /// </summary>
        public Task<VoiceServiceRequest> SendEvent(string eventJson, WitRequestOptions requestOptions)
        {
            if (_voiceService == null)
            {
                return null;
            ...
            return _voiceService.Activate(eventJson, requestOptions);
        }
